    ...
    with col2:
        ...
        with st.container():
            ...
            def plot_radar_chart(scores):
                ...
                fig, ax = plt.subplots(figsize=(3, 3), subplot_kw=dict(polar=True))  # Dynamically reduce size
                ...
                ax.set_title("Startup Strengths & Weaknesses", fontsize=10, fontweight="bold", pad=20)  # Adjust title placement
