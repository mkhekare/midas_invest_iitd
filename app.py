...
with st.container():
    # Use two columns: left for sliders, right for radar chart and recommendations
    col1, col2 = st.columns([1.2, 2])  # Adjust column widths for better balance
    ...
    with col2:
        ...
        with st.container():
            ...
            def plot_radar_chart(scores):
                ...
                fig, ax = plt.subplots(figsize=(5, 3), subplot_kw=dict(polar=True))  # Adjust size to fit layout
